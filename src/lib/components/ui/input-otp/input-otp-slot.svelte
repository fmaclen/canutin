...
<InputOTPPrimitive.Cell
	...
	class={cn(
		...
		cell.isActive &&
			'border-ring ring-ring/50 ring-offset-background aria-invalid:border-destructive aria-invalid:ring-destructive/20 dark:aria-invalid:ring-destructive/40 z-10 ring-[3px]',
		className
	)}
	{...restProps}
>
