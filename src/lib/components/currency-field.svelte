<script lang="ts">
	...
	const baseClass =
		'border-input bg-background ring-offset-background selection:bg-primary selection:text-primary-foreground placeholder:text-muted-foreground dark:bg-input/30 flex h-9 w-full min-w-0 rounded border px-2 py-1 transition-[color,box-shadow] outline-none disabled:cursor-not-allowed disabled:bg-border/33 focus-visible:border-ring focus-visible:ring-ring/50 focus-visible:ring-[3px] font-mono';
