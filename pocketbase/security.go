...
func createSecurityWithInitialBalanceHandler(app core.App) func(*core.RequestEvent) error {
	return func(re *core.RequestEvent) error {
		...
		if err := app.RunInTransaction(func(txApp core.App) error {
			...
			balance.Set("quantity", body.Balance.Quantity)
			balance.Set("price", body.Balance.Price)
			balance.Set("value", body.Balance.Value)
			balance.Set("costBasis", body.Balance.CostBasis)
