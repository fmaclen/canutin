...
migrate((app) => {
  const collection = new Collection({
    "createRule": "grantedBy = @request.auth.id && asset.owner = @request.auth.id && recipient != @request.auth.id",
    ...
    "id": "pbc_2019661285",
    "indexes": [
      "CREATE UNIQUE INDEX idx_assetShares_asset_recipient ON assetShares (asset, recipient)"
    ],
  ...
  const collection = app.findCollectionByNameOrId("pbc_2019661285");
